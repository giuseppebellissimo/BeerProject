...
SECRET_KEY = 'django-insecure-r1!i-j#u4^z8gtz+161rfc_bs1%z&#k340ubwf_8kx!#t$@@f4'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    'services.ing.unimore.it', 'localhost'
]
